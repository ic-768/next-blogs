  ...
  return (
    <div className="grid grid-cols-1 gap-16 pt-8 md:grid-cols-2 lg:grid-cols-3">
      <TextCard title="Empower Your Creativity" image={Landing1}>
        Unlock your potential as a content creator with NextBlogs. Whether
        ...
        sleek designs to powerful editing tools, NextBlogs empowers you to
        express yourself with ease.
      </TextCard>
      <TextCard title="Effortless Design" image={Landing2}>
        Say goodbye to complicated coding and design headaches. With NextBlogs,
      ...
      <TextCard title="Seamless Publishing" image={Landing3}>
        Ready to share your thoughts with the world? With NextBlogs, publishing
      ...
      <TextCard title="Start Your Blogging Journey Today" image={Landing5}>
        ...
        up for NextBlogs now and embark on your blogging journey with
        confidence. Whether you&apos;re blogging for fun or aiming to turn your
        passion into a career, NextBlogs is the perfect platform to help you
        achieve your goals.
      </TextCard>
    </div>
  );
